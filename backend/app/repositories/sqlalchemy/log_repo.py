...
_SUMMARY_COLUMNS = [
    ...
    RequestLogORM.cache_read_tokens,
    RequestLogORM.cache_creation_tokens,
    RequestLogORM.total_cost,
    RequestLogORM.input_cost,
    RequestLogORM.output_cost,
    RequestLogORM.cached_input_cost,
    RequestLogORM.cached_output_cost,
    RequestLogORM.cache_creation_cost,
...
class SQLAlchemyLogRepository(LogRepository):
    ...
    def _row_to_summary(self, row) -> RequestLogSummary:
        ...
        return RequestLogSummary(
            ...
            cached_input_cost=float(row["cached_input_cost"]) if row["cached_input_cost"] is not None else None,
            cached_output_cost=float(row["cached_output_cost"]) if row["cached_output_cost"] is not None else None,
            cache_creation_cost=float(row["cache_creation_cost"]) if row["cache_creation_cost"] is not None else None,
    ...
    async def create(self, data: RequestLogCreate) -> RequestLogModel:
        ...
        entity = RequestLogORM(
            ...
            cache_creation_cost=data.cache_creation_cost,
        ...
        return RequestLogModel(
            ...
            cache_creation_tokens=entity.cache_creation_tokens,
